...
class _CFRSolverBase(object):
  ...
  def __init__(self, game, player, alternating_updates, linear_averaging,
...
class _CFRSolverSingleAgent(_CFRSolverBase):
...
class CFRPlusSolver(_CFRSolverSingleAgent):
  """CFR+ implementation.
...
class CFRSolver(_CFRSolverSingleAgent):
